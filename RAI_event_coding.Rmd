...
dat5 = readxl::read_xlsx("C:/Users/lukes/OneDrive/Documents/RAI_retrain_diplomatic_statement.xlsx")
...
prompt5 = "I have an important coding task that I would like you to complete. I'm going to give you a list of news articles that have been translated into English. For each article, I'll give you the title and a chunk of the main text. Please read the text that I provide and code each article according to the definition below.\n 
> Articles reporting on a public statement made by members or representatives of one country’s government about the actions of another country’s government, citizens, or firms.\n
For each article, provide a 'Yes' or 'No' answer indicating whether the article meets the definition. Please give 1 sentence describing your reasoning."

c(prompt5, "\n", datm5) %>%
  write_lines('C:/Users/lukes/OneDrive/Documents/gpt_input5.txt')
```
